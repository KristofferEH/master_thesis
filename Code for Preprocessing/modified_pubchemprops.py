"""
This code is almost a copy and paste from the package pubchemprops. All credit goes to the original author. 
The only difference is that I have have modified the get_second_layer_props function to accept a CID as input.
"""
...
def get_second_layer_props(compound_name, required_properties, cid_input = False):
    """
        1. Accepts the compound name
